...
app = FastAPI(
    ...
    description="A single backend for RAG Chatbot, AI Voice Bot, and Multilingual Chatbot.",
    version="1.0.0"
)
...
app.include_router(multilingual_router.router, prefix="/multilingual", tags=["Multilingual Chatbot"])
